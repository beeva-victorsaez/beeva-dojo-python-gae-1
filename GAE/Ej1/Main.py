...
from GAE.Ej1.beans import Maleante
from GAE.Ej1.beans import Chivato
from GAE.Ej1.beans import Cazarecompensas
from GAE.Ej1.beans import Informe
from GAE.Ej1.utils import ClassUtils
from GAE.Ej1.Constants import Constants
...
def init_game():
    ...
    Logger.log("______________________________________________________________________________")
    Logger.log(" |Nombre:" + str(cazarecompensas.nombre) + "| ingresos:" + str(cazarecompensas.ingresos) +
    ...
    for maleante in lista_total_maleantes:
        Logger.log("       |Nombre:" + str(maleante.nombre) + "|  Recompensa:" + str(maleante.recompensa) +
            "|  Vida:" + str(maleante.vida) + "|  Localizacion:" + str(maleante.localizacion) + "|")
    #-------------------------------------------------------------------------------------


    #--------- Log datos de los CHIVATOS (aleatorios) ----------------------------------------
    Logger.log("- Los chivatos son:" + str(len(lista_total_chivatos)))
    for chivato in lista_total_chivatos:
        ...
        Logger.log(str(info_chivato) + "|")
    #----------------------------------------------------------------------------------------------------
    Logger.log("______________________________________________________________________________")
    Logger.log("")
    Logger.log("El tiempo total que tiene el cazarecompensas es " + str(tiempo))
...
def generarInforme():
    ...
    Logger.log("Recompnsa total: " + str(recompensa))

    Logger.log("Time: " + str(getTime()))
    Logger.log("###################################################")
